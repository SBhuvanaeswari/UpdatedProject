...
public class TestFinancierBranchMasterViewPage extends BaseTestclass {

	@Test
	public void FinancierBranchMaster_View() throws InterruptedException {
		...
		Thread.sleep(1000);
		String fincode = FWUtills.read_XL_Data(XL_DATA_PATH, "FinancierMaster_Modify", 1, 0);
		String finaname = FWUtills.read_XL_Data(XL_DATA_PATH, "FinancierMaster_Modify", 1, 1);
		String fbcode = FWUtills.read_XL_Data(XL_DATA_PATH, "FinancierMaster_Modify", 1, 2);
		String finbrchname = FWUtills.read_XL_Data(XL_DATA_PATH, "FinancierMaster_Modify", 1, 3);
		String ifcode = FWUtills.read_XL_Data(XL_DATA_PATH, "FinancierMaster_Modify", 1, 4);
		String MICRcode = FWUtills.read_XL_Data(XL_DATA_PATH, "FinancierMaster_Modify", 1, 5);
		...
		if (invisible) {
			...
			gmp.clickFinancierBranchMasterView();
			Thread.sleep(2000);
...
//		Fbm.LovBranchname(finbrchname);
			...
			Fbm.ViewEdit();
			/*
			 * Thread.sleep(2000); Fbm.Viewclose(); Thread.sleep(2000); Alert
			 * confirm=driver.switchTo().alert(); confirm.dismiss(); Thread.sleep(1000);
			 * driver.navigate().refresh();
			 */
		}
	}
