...
public class TestContractorMasterViewPage extends BaseTestclass {

	@Test
	public void ContractorMaster_View() throws InterruptedException {
		...
		if (invisible) {
			...
			contrms.Viewlink();
			/*
			 * Thread.sleep(2000); contrms.Submitclick(); Thread.sleep(1000);
			 * contrms.close.click();
			 * 
