...
import Com.UIIC.objects1.RsikLocationMasterAddPage;


public class TestRiskLocationMasterAddPage extends BaseTestclass {

	@Test
	public void RiskLocationMaster_Add() throws InterruptedException {
		...
		String enddt = FWUtills.read_XL_Data(XL_DATA_PATH, "RiskLocationMaster", 1, 6);
		...
		if (invisible) {
			...
			Thread.sleep(2000);
			 ...
			 Gm.clickriskLocationMasterAdd();
			Thread.sleep(1000);
			RsikLocationMasterAddPage Rm = new RsikLocationMasterAddPage(driver);
