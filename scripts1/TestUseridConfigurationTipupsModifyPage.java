...
public class TestUseridConfigurationTipupsModifyPage extends BaseTestclass {

	@Test
	public void UseridConfigurationTipups_Modify() throws InterruptedException {
		...
		if (invisible) {
			...
			Gm.clickUseridConfigurationModify();
			Thread.sleep(1000);
			...
			Uc.EnterModifyOEMUserName(OEMuserid);
			Uc.clickModifySearch();
			Uc.Edit();
