...
public class TestUseridConfigurationTipupsViewPage extends BaseTestclass {

	@Test
	public void UseridConfigurationTipups_View() throws InterruptedException {
		...
		if (invisible) {
			...
			Gm.clickUseridConfigurationView();
			Thread.sleep(1000);
