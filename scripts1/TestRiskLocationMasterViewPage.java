...
public class TestRiskLocationMasterViewPage extends BaseTestclass {

	@Test
	public void RiskLocationMaster_View() throws InterruptedException {
		...
		if (invisible) {
			...
			Thread.sleep(2000);
			 ...
			 Gm.clickRiskLocationMasterView();
			Thread.sleep(1000);
