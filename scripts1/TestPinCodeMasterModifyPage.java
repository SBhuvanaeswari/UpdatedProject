...
import Com.UIIC.objects1.PincodeMasterModifyandViewPage;

public class TestPinCodeMasterModifyPage  extends BaseTestclass {

	@Test
	public void PincodeMaster_Modify() throws InterruptedException {
		...
		if (invisible) {
			...
			Thread.sleep(2000);
			 ...
			 Gm.clickPinCodeMasterModify();
			Thread.sleep(1000);
			PincodeMasterModifyandViewPage Pm = new PincodeMasterModifyandViewPage(driver);
